package com.cognizant.pensionManagementSystem.processPension.service;
...
import com.cognizant.pensionManagementSystem.processPension.dao.ProcessPensionServiceDao;
import com.cognizant.pensionManagementSystem.processPension.model.Pensioner;
import com.cognizant.pensionManagementSystem.processPension.restClients.AuthClient;
import com.cognizant.pensionManagementSystem.processPension.restClients.PensionDisbursementClient;
import com.cognizant.pensionManagementSystem.processPension.restClients.PensionerDetailClient;
...
public class ProcessPensionServiceDaoImpl implements ProcessPensionServiceDao {
	...
	public boolean validatePensionerDetails(String token, String name, Date dob, String pan, long aadhaarNumber,
		...
		if (isSessionValid(token)) {
			...
			logger.info(pensioner.toString());
			...
			System.out.println(pensioner.getName().equalsIgnoreCase(name)
