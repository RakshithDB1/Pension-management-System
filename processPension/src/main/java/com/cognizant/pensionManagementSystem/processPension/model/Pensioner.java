...
public class Pensioner {
	...
	public String toString() {
		return "Pensioner [name=" + name + ", dateOfBirth=" + dateOfBirth + ", panNumber=" + panNumber + ", salary="
				+ salary + ", allowances=" + allowances + ", typeOfPension=" + typeOfPension + ", aadhaarNumber="
				+ aadhaarNumber + ", bankName=" + bankName + ", accountNumber=" + accountNumber + ", bankServiceCharge="
				+ bankServiceCharge + ", pensionAmount=" + pensionAmount + "]";
	}
